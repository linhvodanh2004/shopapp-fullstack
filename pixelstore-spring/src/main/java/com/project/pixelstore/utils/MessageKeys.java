...
public class MessageKeys {
    ...
    public static final String INVALID_PHONE_OR_PASSWORD = "user.login.invalid_phone_or_password";
    ...
    public static final String CREATE_ADMIN_FAILED = "user.register.create_admin_failed";
